...
1. Na table **Hodnota životnosti zákazníka (verzia Preview)** vyberte **Začíname**.
...
1. V kroku **Plán aktualizácie údajov** vyberte frekvenciu preškolenia modelu na základe najnovších údajov. Toto nastavenie je dôležité na aktualizáciu presnosti predikcií pri prijímaní nových údajov v prehľadoch cieľových skupín. Väčšina firiem môže preškoľovať raz mesačne a získať dobrú presnosť pre svoju predikciu.
